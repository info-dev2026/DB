...
export declare class MongoBinaryDownload {
     ...
     */
    extractTarGz(mongoDBArchive: string, extractPath: string, filter: (file: string) => boolean): Promise<string | undefined>;
    /**
     ...
     * @returns The md5 checksum of the extracted file, if there was one.
     */
    extractZip(mongoDBArchive: string, extractPath: string, filter: (file: string) => boolean): Promise<string | undefined>;
    /**
